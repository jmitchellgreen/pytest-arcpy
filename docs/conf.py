# -*- coding: utf-8 -*-
#
# pytest-arcpy documentation build configuration file, created by
...
project = 'pytest-arcpy'
copyright = '2015, J. Mitchell Green'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', 'pytest-arcpy Documentation',
     [author], 1)
]
